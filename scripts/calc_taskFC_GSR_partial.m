...
All_subj_all_task_FC_GSR_partialr=zeros(360,360,64,100);
All_subj_all_task_FC_GSR_partialp=zeros(360,360,64,100);
...
for subjNum=1:100
    ...
    for taskNum=1:64
        ...
        [TaskFC_corr_r,TaskFC_corr_p]=partialcorr(tasktimepoints_bytask');
        All_subj_all_task_FC_GSR_partialr(:,:,taskNum,subjNum)=TaskFC_corr_r;
        All_subj_all_task_FC_GSR_partialp(:,:,taskNum,subjNum)=TaskFC_corr_p;
        clear tasktimepoints_bytask
    end
end
       
All_subj_all_rest_FC_GSR_partialr=zeros(360,360,100);
All_subj_all_rest_FC_GSR_partialp=zeros(360,360,100);
        
for subjNum=1:100
    subjNum
        [RestFC_corr_r,RestFC_corr_p]=partialcorr(output.restGLMVars{subjNum}.fMRI_resids');
        All_subj_all_rest_FC_GSR_partialr(:,:,subjNum)=RestFC_corr_r;
        All_subj_all_rest_FC_GSR_partialp(:,:,subjNum)=RestFC_corr_p;
end        
