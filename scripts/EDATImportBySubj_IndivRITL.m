function EDATImport = EDATImportBySubj_IndivRITL(importFileEndString, subjNums)
...
importNum=1;
for  subjIndex=1:length(subjNums)
    subjNum = subjNums{subjIndex};
    
    dataName = 'fMRI_CPRO_IndivRITL';
    dataName = [subjNum '_' dataName];
